...
const categories = [
  ...
  { name: "Beauty", imgSrc: "https://via.placeholder.com/50", path: "/shop" },
  {
    name: "Home & Kitchen",
    imgSrc: "https://via.placeholder.com/50",
    path: "/shop",
  ...
  { name: "Travel", imgSrc: "https://via.placeholder.com/50", path: "/shop" },
  { name: "Grocery", imgSrc: "https://via.placeholder.com/50", path: "/shop" },
];
